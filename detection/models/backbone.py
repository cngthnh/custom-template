...
from detection.utils.utils import download_pretrained_weights
    ...
    def __init__(
        ...
        **kwargs):
        ...
        if version=='4':
            ...
            self.model = Yolov4(
                cfg=f'./detection/models/yolo/configs/yolov4-{version_mode}.yaml', ch=3, nc=num_classes
            )
        elif version =='5':
            version_mode = version_name[-1]
            self.name = f'yolov5{version_mode}'
            self.model = Yolov5(
                cfg=f'./detection/models/yolo/configs/yolov5{version_mode}.yaml', ch=3, nc=num_classes
            )
